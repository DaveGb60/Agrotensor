  ...
  const DonateInfo = () => (
    <div className="space-y-3">
      ...
      <p className="text-sm text-muted-foreground">
        If FarmDeck helps your farm, please consider supporting development. All donations are securely processed via Polar.
      </p>
      <Button
        asChild
        size="sm"
      ...
      >
        <a href={POLAR_DONATION_URL} target="_blank" rel="noopener noreferrer">
