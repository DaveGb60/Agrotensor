...
const LandingHero: React.FC = () => {
  return (
    <>
      ...
      <section className="fd-hero" aria-label="AgroTensor hero">
        <div className="fd-hero__overlay">
          <div className="fd-hero__container">
            <div className="fd-hero__left">
              ...
              <p className="fd-lead">Organize your data, monitor operations, analyze insights and grow profit — AgroTensor is your farm's digital office, built for farmers and farm teams.</p>
            ...
            <div className="fd-hero__right">
              <img src="/assets/landing/dashboard_preview.svg" alt="AgroTensor app preview" className="fd-mock"/>
            </div>
          </div>
        </div>
      </section>
